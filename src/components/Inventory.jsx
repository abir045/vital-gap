      ...
      <div className="w-full bg-[#fff] rounded-md relative">
        ...
        <header className="flex lg:flex-row flex-col items-center gap-12 lg:gap-0 justify-between px-8 mt-10">
          ...
          <div className="w-full lg:w-[55%]">
            <img src={inventory} alt="image" className="" />
          </div>
        </header>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[20px] mt-10 w-[70%]">
            <div>
              ...
              <p className="text-[0.9rem] text-gray-500 mt-1">
                Avoid negative inventory data with our backorder management for
                inventories.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-[0.9rem] text-gray-500 mt-1">
                Inventory Audit reports to show discrepancies in physical count.
              </p>
            </div>
          </div>
        </section>
